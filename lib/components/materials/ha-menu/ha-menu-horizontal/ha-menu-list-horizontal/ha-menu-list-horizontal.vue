      ...
      if(menuList.menuList) {
        return menuList.menuList.map( listItem => {
          if(listItem.groupId) { //代表是group
            ...
            return (
              <div class="ha-menu-list-horizontal-groupParent-default ha-menu-list-horizontal-groupParent">
                <div 
                class={ ["ha-menu-list-horizontal-group-default", this.bgColorClass[0], "ha-menu-list-horizontal-group"] }
                onclick={ (e) => {
                  if(this.listener) {
          ...
          if(listItem.title) { //代表是item
            ...
            return(
              <div
              class={ ["ha-menu-list-horizontal-item-default", this.bgColorClass[1]||this.bgColorClass[0], "ha-menu-list-horizontal-item"] }
