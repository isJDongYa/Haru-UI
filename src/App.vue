  ...
  <div id="mainApp">
    <ha-rectangle height='99%' width='100%'>
      <ha-coordinater :grid="[[1180, 50, 50], [580, 25, 50]]">
        ...
        <ha-card :color="['grey', 'white', 'lightGrey']" :coor="[[[10,18], [10,18]]]" :styleProp="btnStyle" hover="shadow">
            ...
            menuList: [
              {
                ...
                menuList: [
                  {
                    title: 'Primary',
                    route: '/home/color/primary'
                  },
                  {
                    title: 'lightPrimary',
                    route: '/home/color/lightprimary'
                  },
                  {
                    title: 'darkPrimary',
                    route: '/home/color/darkprimary'
                  },
                  {
                    title: 'accentPrimary',
                    route: '/home/color/accentprimary'
                  }
                ]
              },
              {
                title: 'Coordinater',
                route: '/home/coordinater'
              },
              {
                groupId: '3',
                ...
                menuList: [
                  {
                    ...
                    menuList: [
                      {
                        title: 'Rectangle',
                        route: '/hone/components/containers/rectangle'
                      },
                    ] 
                  },
                  {
                    ...
                    menuList: [
                      {
                        title: 'Button',
                        route: '/hone/components/stuffings/button'
                      },
                    ] 
                  }
                ] 
